  ...
  <article class="grid grid-cols-12 gap-4 w-full md:w-6/12 lg:w-4/12 xl:w-4/12 mx-auto ">
    ...
    <span class="material-symbols-outlined h-10 w-10 text-center flex jusitfy-center items-center bg-white p-2 rounded-lg">person</span>
        ...
        class="p-2 m-2 focus:border-b-2 
           ...
           <!-- Password -->
           <div class="flex p-2 m-2 flex-row items-center col-span-12 ">
              <svg class="h-10 w-10 text-center flex jusitfy-center items-center bg-white p-2 rounded-lg"  viewBox="-64 0 512 512" width="20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="relative col-span-6 p-2 m-2 leading-loose">
                <span  class="font-semibold text-xl bg-clip-text text-transparent 
                bg-gradient-to-br from-red-500 to-orange-500"  @click="BtnshowHelpText">
                    password policy 
                  </span>
                  <span v-if="showHelpText" class=" font-serif absolute top-10 left-0 right-0 w-full bg-white text-gray-700 p-2 rounded-lg shadow-md border border-gray-300">
                    <ul>
            ...
            <div class="col-span-12 flex flex-col items-center justify-center ">
              ...
              <button class=" w-full  btn xl:w-3/12 
              ...
              <button @click="cancel" class=" w-full btn xl:w-3/12 
