<template>
    ...
    <div id ="data_user" class=" relative p-2 m-2" >
        <div class="flex grid grid-cols-12 gap-4 py-2 my-2 ">
            ...
            <button class="col-span-4 w-full  xl:col-span-1 btn bg-gradient-to-br from-yellow-500 via-amber-500 to-orange-500 text-yellow-200 px-5 py-2 m-2 rounded-lg font-semibold"  v-show="data.length>0" @click="update_button">Update</button>
            <button class="col-span-4 w-full xl:col-span-1 btn bg-gradient-to-br from-red-500 via-rose-500 to-pink-500 text-red-200 px-5 py-2 m-2 rounded-lg font-semibold"   v-show="data.length>0" @click="delete_button">Delete</button>
        </div>
        <div class="flex flex-col xl:grid xl:grid-cols-12 gap-6 flex-wrap p-2 m-2">
            <a class="font-semibold hover:bg-gradient-to-br from-blue-500 via-sky-500 to-cyan-500 hover:text-gray-50 bg-white hover:shadow-2xl 
